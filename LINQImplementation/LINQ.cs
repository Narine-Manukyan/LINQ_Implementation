...
namespace LINQImplementation
{
    ...
    public static class LINQ
    {
        ...
        public static IEnumerable<TResult> ExtensionSelectMany<TSource, TResult>
            ...
            (this IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
        {
            ...
            List<TSource> list = ExtensionToList(source);
            ...
            (this IEnumerable<TSource> source, Func<TSource, TKey> keySelector)
        {
            ...
            // Creating List from source.
            List<TSource> list = ExtensionToList(source);
            // Returning sorted list with descending order.
